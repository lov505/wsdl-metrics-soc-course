		...
		while (iter.hasNext()) {			
			...
			while (opers.hasNext()) {
				...
				if (op.getInput() != null) {
					...
					Logger.getLogger(MetricsSuite.class.getName()).debug("La operación: " + op.getQName().getLocalPart() + " no tiene Input.");
				}
				if (op.getOutput() != null) {
					...
					Logger.getLogger(MetricsSuite.class.getName()).debug("La operación: " + op.getQName().getLocalPart() + " no tiene Output.");
				}
			}			
		}
		return DW;
